...
"""
#a
print "Classified only by submeter" + str(elec.submeters())
print "#####################################"
#b
print "Calculating total energy for elecmaterID" + str(elec.mains().total_energy())
print "#####################################"
#c
energy_per_meter = elec.submeters().energy_per_meter()
print "Calculating total energy for submeter (per appliance)" + str(energy_per_meter)
print "#####################################"
#d
energy_per_meter = energy_per_meter.loc['active']
more_than_100 = energy_per_meter[energy_per_meter > 100]
print more_than_100
print "#####################################"
print hair.total_energy()

###############################################################################################
# 7. Disaggregation and Metrics ###############################################################
###############################################################################################
building = 1
print train.buildings[building].elec.mains().plot()
