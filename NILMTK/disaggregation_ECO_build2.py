...
total = DataSet('/home/rizky/nilmtk/data/eco.h5')
train = DataSet('/home/rizky/nilmtk/data/eco.h5')
test = DataSet('/home/rizky/nilmtk/data/eco.h5')
...
if building == 1:
	...
	#Train 02 Juni - 20 Juni, Test 21 Juni - 20 Juli Month
    train.set_window(start="2012-06-02",end="2012-06-20")
    test.set_window(start="2012-06-21",end="2012-07-20")	
    print(2)
   ...
   #Train 3/4 Month, Test 1 Month
    train.set_window(start="2012-11-11",end="2012-11-30")
    test.set_window(start="2012-12-01",end="2012-12-30")
...
start = time.time()
disag_filename = 'data/fhmm_out/fhmm_building2_1vs1.h5'
...
def jaccard_similarity(predictions, ground_truth):
    ...
    ground_truth = ground_truth.drop(ground_truth.columns[[0,1,2,3,5,10,11]], axis=1); # remove column 1, 2, 3
...
# Ja
#print("starting Ja FHMM");
#Ja_fhmm = jaccard_similarity(disag_fhmm_elec_df_nona, gt_df_nona);
#print(Ja_fhmm);
