...
def jaccard_similarity_b2_k5(predictions, ground_truth):
    predictions = predictions.drop(predictions.columns[[0]], axis=1) 
    ground_truth = ground_truth.drop(ground_truth.columns[[0,1,2,3,4,5,9,10,11,12]], axis=1)
    predictions.columns = ['7', '8', '9', '14', '15']
    ground_truth.columns = ['7', '8', '9', '14', '15']
    pred_a_gt = predictions.astype(bool) & ground_truth.astype(bool)
    pred_u_gt = predictions.astype(bool) | ground_truth.astype(bool)
    sum_pred_a_gt = pred_a_gt.sum(axis=1)
    sum_pred_u_gt = pred_u_gt.sum(axis=1)
...
if building == 1:
    ...
    #train windows 4 train 3/4 month test 1 day
    train.set_window(start="06-28-2012", end="07-8-2012")
    test.set_window(start="06-10-2012", end="06-12-2012")
    print(2)
elif building == 3:
...
for i in disag_co_elec.submeters().instance():
    ...
    plt.savefig('/media/airawan/DATA/Data/ecoori/comp' + fig_name + ' 2d_eco.png')
