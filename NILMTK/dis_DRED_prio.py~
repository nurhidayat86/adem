...
# there is no other building in DRED dataset
building = 1
...
#get good sections
total_gs = total_elec.good_sections()
print(total_gs)

# check good section each appliances
ins = total_elec.submeters().instance()

for i in ins:
    print(total_elec[i].good_sections())

#train.set_window(start="07-05-2015", end="08-05-2015")
#test.set_window(start="08-01-2015", end="08-02-2015")
...
"""
print("CO CENTROIDS MODEL")
meta_dred = Metadata("DRED").centroids
co.train_centroid(train_elec, centroids = meta_dred)
# co.train_centroid(top_5_train_elec, centroids = meta_dred)
end = time.time()
