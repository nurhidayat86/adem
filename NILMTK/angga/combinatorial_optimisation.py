...
class CombinatorialOptimisation(Disaggregator):
    ...
    def train_centroid(self, metergroup, max_num_clusters = 3, resample_seconds=60, centroids=None):
        self.model = []       
    ...
    def disaggregate_chunk(self, mains, vampire_power=None):
        ...
        # add priority
        last_combi = summed_power_of_each_combination[indices_of_state_combinations[0]]
        ...
        for i in range(len(indices_test)-1):
            ...
            if abs(mains.values[i+1] - last_combi) <= delta:
                ...
                last_combi = summed_power_of_each_combination[indices_test[i+1]]
