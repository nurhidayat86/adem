from nilmtkECOappliance import nilmtkECOfunc, FTE_func
dataset_loc = '../dataset/eco.h5'
dis, gt, model = nilmtkECOfunc(dataset_loc, "06-02-2012", "06-09-2012", "06-11-2012", "06-12-2012", 60) 


from nilmtkECOappliance import nilmtkECOfunc, FTE_func, co_train
dataset_loc = '../dataset/eco.h5'
co = co_train(dataset_loc, "06-02-2012", "09-02-2012", 60)
...
dis, gt, model, train = nilmtkECOfunc(dataset_loc, "06-02-2012", "06-09-2012", "06-11-2012", "06-12-2012", 60) 

train_start = "06-02-2012"
train_end = "06-09-2012"
test_start = "06-11-2012"
test_end = "06-12-2012"
output_period = 60
