...
for i in os.listdir(path + '02_sm_csv/02_test/'):
    if i.endswith(".csv"): 
        d_data = pd.read_csv(filepath_or_buffer = path + '02_sm_csv/02_test/' + i, header=None, sep=',');
...
occ_data = pd.read_csv(filepath_or_buffer= path + '02_occupancy_csv/02_summer.csv', skiprows=0, sep=',');
