...
#Looking for hidden states
X_hmm = np.concatenate([all_features_reduced, y_train])
lengths = [len(all_features_reduced), len(y_train)]
model = hmm.GaussianHMM(n_component=35).fit(X_hmm)
